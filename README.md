Desafio Aula01 - A importância de utilização de classe na poo.

A utilização de classes é fundamental porque elas funcionam como moldes organizadores para o código, colocando o sistema em blocos modulares.
Elas garantem a reutilização de lógica e a criação de inúmeros objetos a partir de uma estrutura única, economizando tempo de desenvolvimento. Também proporcionam 
